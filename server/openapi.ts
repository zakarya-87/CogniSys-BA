...
export const openApiSpec = {
  ...
  tags: [
    ...
    { name: 'Invitations', description: 'Token-based org invitation flow' },
    { name: 'Members', description: 'Org member management and role changes' },
    { name: 'Notifications', description: 'In-app notifications and real-time SSE stream' },
    { name: 'Audit Logs', description: 'Field-level mutation history (admin only)' },
    { name: 'Usage', description: 'AI call metering and quota management' },
    { name: 'Billing', description: 'Stripe subscription management' },
    { name: 'Analytics', description: 'Org activity, initiative metrics, AI usage trends' },
    { name: 'Webhooks', description: 'Outbound HMAC-signed event delivery' },
    { name: 'Search', description: 'Cross-collection full-text search' },
    { name: 'Admin Jobs', description: 'Cloud Scheduler-triggered background jobs' },
  ],
};
